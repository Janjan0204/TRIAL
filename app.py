...
def result():
    ...
    return render('result.html', province=province, city=city,
                           day1_weather=day1_weather, day2_weather=day2_weather,
...
def submit():
    ...
    return render('result.html', day1_weather=day1_weather, day2_weather=day2_weather, day3_weather=day3_weather, day4_weather=day4_weather)
